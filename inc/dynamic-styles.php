...
.query-directory-image-grid.has-{$slug}-color,
...
.query-directory-image-grid.has-{$slug}-background-color,
...
.query-directory-image-grid.has-{$background_slug}-background-color.has-{$text_slug}-color,
