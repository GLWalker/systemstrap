...
<!-- wp:group {"metadata":{"patternName":"systemstrap/content-woocommerce-single-product"},"align":"full","className":"woocommerce product","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"layout":{"type":"constrained"}} -->
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-woocommerce-product-meta">
					...
					<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10","margin":{"bottom":"var:preset|spacing|20"}}},"layout":{"type":"constrained"}} -->
					<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--20)">

						<!-- wp:post-terms {"term":"product_cat","prefix":"Category: ","separator":" ","className":"is-style-system-badge","style":{"layout":{"selfStretch":"fit","flexSize":null}}} /-->
