 ...
 * Title: Offcanvas Top Main
 * Slug: systemstrap/offcanvas-top
 * Inserter: no
 */
?>
...
<div class="wp-block-group offcanvas-body">
 <!-- wp:categories {"showPostCounts":true,"showOnlyTopLevel":true,"className":"is-style-system-list"} /-->
