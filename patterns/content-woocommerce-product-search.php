...
<!-- wp:group {"tagName":"section","metadata":{"patternName":"systemstrap/content-woocommerce-product-search"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-group alignfull">
		...
		<div class="wp-block-woocommerce-product-collection alignwide">
			...
			<!-- wp:woocommerce/product-template {"className":"is-style-system-panel-woo"} -->
