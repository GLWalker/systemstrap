 ...
 * Slug: systemstrap/content-comments
 * Inserter: no
 */

?>

<!-- wp:group {"tagName":"section","metadata":{"patternName":"systemstrap/content-comments"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"backgroundColor":"tertiary-bg","layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull has-tertiary-bg-background-color has-background" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-group alignfull">
		...
		<header class="wp-block-group alignfull comments-header">
			...
			<!-- wp:comments-title {"level":2,"className":"comment-title"} /-->

			<!-- wp:separator {"lock":{"move":true,"remove":true},"className":"strap-action-hook strap_hook_end_comments_header"} -->
			<hr class="wp-block-separator has-alpha-channel-opacity strap-action-hook strap_hook_end_comments_header" />
			<!-- /wp:separator -->
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-comments comments use-form-control use-validation use-form-check use-form-label">
				...
				<!-- wp:comment-template -->
					...
					<!-- wp:group {"tagName":"article","className":"comment-body","style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"default"}} -->
				...
				<!-- wp:comments-pagination {"paginationArrow":"chevron","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
